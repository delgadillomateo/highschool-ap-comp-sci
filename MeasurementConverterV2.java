...
/**
 * Measurement ConverterV2 : a program to convert to and from English and metric units of measurement.
 * 
 * Mateo Delgadillo 
 * November 15th 2014
 */
public class MeasurementConverterV2
{
    ...
    public static double convertLiterToGallon(double L)
    {
        return L * 0.264172;
    }
    //convert gallons to liters
    public static double convertGallonToLiter(double gal)
    {
        return gal / 0.264172;
    }
    ...
    public static void main(String[ ] args)
    {
        ...
        System.out.printf("%8.1f lb. - %7.1f kg. %n", pounds, kilogram);
       
        kilogram = 1800;
        pounds = convertKilogramsToPounds(kilogram);
        System.out.printf("%8.1f kg. - %7.1f lb. %n", kilogram, pounds);
        
        double gallon = 25;
        double liter = convertGallonToLiter(gallon);
        System.out.printf("%8.1f gal. = %7.1f L. %n", gallon, liter);
        
        liter = 8;
        gallon = convertLiterToGallon(liter);
        System.out.printf("%8.1f L. = %7.1f gal. %n", liter, gallon);
